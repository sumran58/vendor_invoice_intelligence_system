#I designed a modular ML pipeline that loads data, preprocesses it, trains multiple regression models, evaluates them using MAE, selects the best-performing model, and persists it using joblib for deployment.”

import joblib #Used to save and load trained ML models
from pathlib import Path#To handle file paths easily (better than normal strings)
